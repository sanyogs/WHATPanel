...
$name = array(
	'name'	=> 'name',
	'placeholder' => lang('hd_lang.name'),
	'value' => set_value('name')
);

$email = array(
	'name'	=> 'email',
	'placeholder' => lang('hd_lang.email'),
...
$subject = array(
	'name'	=> 'subject',
	'id'	=> 'subject',
	'placeholder' => lang('hd_lang.subject') 
);

$message = array(
	'name'	=> 'message',
	'id'	=> 'message',
	'placeholder' => lang('hd_lang.message'),
	'rows' => '7',
    'cols' => '40',
	'size'	=> 20,
			...
			<fieldset>
				...
				<div class="Contact-us">
					...
					<div class="form-submit col-md-12">
						<input type="submit" id="submit" class="btn btn-<?=config_item('theme_color');?> pull-right" value="<?=lang('hd_lang.send_message')?>">
					</div>
					...
					<?php } else { ?>
					<tr><td colspan="2"><p><?=lang('hd_lang.enter_the_code_exactly')?></p></td></tr>
