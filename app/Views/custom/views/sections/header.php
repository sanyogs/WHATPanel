        ...
        <nav class="navbar navbar-expand-lg">
          <div class="container-fluid px-0">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <?php $helper->blocks('MAIN MENUI', $helper->get_slug()); ?>
...
<div class="floating">
	<div class="icon-bar">
	<a href="<?=base_url()?>carts/shopping_cart">
		<span class="cart"><i class="fa fa-shopping-cart"></i> 
			<span class="badge badge-warning"><?= null != session()->get('cart') ? count(session()->get('cart')) : 0?></span>
		</span>
	</a> 
	</div>
</div>
