          ...
          echo form_open(base_url().'cart/domain_fields',$attributes); ?>
            ...
            if($this->session->userdata('transfer')){ ?>
                                        <div class="form-group">
                                            <label
                                                class="label-control"><?=lang('hd_lang.domain_transfer')." ".lang('hd_lang.authcode')?>
                                                (<?=lang('hd_lang.authcode_requirement')?>)</label>
                                            <input name="authcode" type="text" class="form-control">
                                            <p><?=lang('hd_lang.auth_epp_required_list')?> .com, .net, .org, .us, .biz, .info,
