 ...
 */ //$section = $this->template->template['partials']; ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <?php use Config\MyConfig;

use function app\Helpers\theme_assets;

 //$config = new MyConfig(); ?>
    <meta charset="utf-8" />
    <?php //$favicon = $config->site_favicon; $ext = substr($favicon, -4); ?>
    <?php //if ( $ext == '.ico') { ?>
    <!-- <link rel="shortcut icon" href="<?= theme_assets(); ?>images/<?//=$config->site_favicon?>"> -->
    <?php //} ?>
    <?php //if ($ext == '.png') { ?>
    <!-- <link rel="icon" type="image/png" href="<?= theme_assets()?>images/<?//=$config->site_favicon?>"> -->
    <?php //} ?>
    <?php //if ($ext == '.jpg' || $ext == 'jpeg') { ?>
    <!-- <link rel="icon" type="image/jpeg" href="<?= theme_assets()?>images/<?//=$config->site_favicon?>"> -->
    <?php //} ?>
    <?php //if ($config->site_appleicon != '') { ?>
    <!-- <link rel="apple-touch-icon" href="<?= theme_assets()?>images/<?//=$config->site_appleicon?>" />
    <link rel="apple-touch-icon" sizes="72x72" href="<?= theme_assets()?>images/<?//=$config->site_appleicon?>" />
    <link rel="apple-touch-icon" sizes="114x114" href="<?= theme_assets()?>images/<?//=$config->site_appleicon?>" />
    <link rel="apple-touch-icon" sizes="144x144" href="<?= theme_assets()?>images/<?//=$config->site_appleicon?>" /> -->
    <?php //} ?>
