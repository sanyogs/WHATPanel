<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title"><?=lang('hd_lang.new_payment')?></h4>
		</div>		
		<div class="modal-body">
			<p><?=lang('hd_lang.paypal_redirection_alert')?></p>
        ...
        ?>
			 ...
			 <div class="form-group">
				<label class="col-lg-4 control-label"><?=lang('hd_lang.reference_no')?></label>
				<div class="col-lg-4">
				...
				<div class="form-group">
				<label class="col-lg-4 control-label"><?=lang('hd_lang.amount')?> (<?=$cur->symbol?>) </label>
				<div class="col-lg-4">
		...
		<button type="submit" class="btn btn-success"><?=lang('hd_lang.pay_invoice')?></button>
		</div>
