        ...
        echo form_open('settings/update', $attributes); ?>
                 ...
                 <img src="<?=base_url()?>resource/images/gateways/mollie.png" alt="Mollie" />
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.mollie_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.mollie_api_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.mollie_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.razorpay_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.razorpay_api_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.razorpay_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.instamojo_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.instamojo_api_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.instamojo_oath_token')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.instamojo_hash')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.instamojo_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.paystack_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.paystack_secret_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.paystack_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.payfast_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.payfast_merchant_id')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.payfast_merchant_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.payfast_passphrase')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.payfast_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                 ...
                 <img src="<?=base_url()?>resource/images/gateways/paypal.png" alt="PayPal" />
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.paypal_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.paypal_email')?></label>
                        <div class="col-lg-4">
                   ...
                   <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.paypal_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.2checkout_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.checkout_publishable_key')?></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?=config_item('2checkout_publishable_key')?>" name="2checkout_publishable_key">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.checkout_private_key')?></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?=config_item('2checkout_private_key')?>" name="2checkout_private_key">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.checkout_seller_id')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.two_checkout_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.stripe_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.stripe_private_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.stripe_public_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.stripe_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.coinpayments_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.coinpayments_private_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.coinpayments_public_key')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.accept_coin')?></label>
                        <div class="col-lg-2">
                            <input type="text" class="form-control" value="<?=config_item('accept_coin')?>" name="accept_coin">
                        </div>
                        <span class="help-block m-b-none small text-danger"><a href="https://www.coinpayments.net/supported-coins" target="_blank"><?=lang('hd_lang.code_list')?></a></span>
                    </div>


                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.coinpayments_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.bitcoin_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.blockchain_xpub')?></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?=config_item('bitcoin_address')?>" name="bitcoin_address">
                        </div>
                         <span class="help-block m-b-none small text-danger"><a href="https://blockchain.info/api/api_receive" target="_blank"><?=lang('hd_lang.read_more')?></a></span>
                         
                    </div>

                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.blockchain_api_key')?></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?=config_item('bitcoin_api_key')?>" name="bitcoin_api_key">
                        </div>
                        <span class="help-block m-b-none small text-danger"><a href="https://api.blockchain.info/v2/apikey/request/" target="_blank"><?=lang('hd_lang.read_more')?></a></span>
                        
                    </div>
                    

                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.bitcoin_active')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-sm btn-<?=config_item('theme_color');?>"><?=lang('hd_lang.save_changes')?></button>
                    </div>
