<div class="row" id="department_settings">
    ...
    <div class="col-lg-12">
        ...
        echo form_open_multipart('settings/departments', $attributes); ?>
             ...
             <div class="box-header">   <h2><?=lang('hd_lang.categories')?></h2> </div>
                <div class="box-body">
                    <input type="hidden" name="settings" value="<?=$load_setting?>">
                    <div class="form-group">
                    <a href="<?=base_url()?>settings/add_category" class="btn btn-<?=config_item('theme_color');?> btn-sm pull-right" data-toggle="ajaxModal" title="<?=lang('hd_lang.add_category')?>"><i class="fa fa-plus"></i> <?=lang('hd_lang.add_category')?></a>
