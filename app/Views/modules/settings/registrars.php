        ...
        echo form_open('settings/update', $attributes); ?>
                ...
                <img src="<?=base_url()?>resource/images/gateways/resellerclub.png" alt="ResellerClub" />
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.resellerclub_live')?></label>
                        <div class="col-lg-4">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.resellerclub_resellerid')?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('hd_lang.resellerclub_apikey')?></label>
                        <div class="col-lg-4">
