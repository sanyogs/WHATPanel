...
<section class="domain_search">
    <div class="forms-main">
        <div class="container">
            ...
            <div id="response"></div>
            <div id="continue">
                <div class="btn-group"><a href="<?=base_url()?>cart/hosting_packages"
                        class="btn btn-warning"><?=lang('hd_lang.add_hosting')?></a><a href="<?=base_url()?>cart/domain_only"
                        class="btn btn-info"><?=lang('hd_lang.domain_only')?></a></div> </span>
            </div>
            ...
            <div class="grid grid-column-2">
                ...
                <div class="column">
                    <form action="#" class="search_form" method="post" id="search_form">
                        ...
                        <button type="submit" id="Transfer"
                            data="<?=lang('hd_lang.domain_transfer')?>"><?=lang('hd_lang.transfer')?></button>
                        <button type="submit" id="btnSearch"
                            data="<?=lang('hd_lang.domain_registration')?>"><?=lang('hd_lang.check_domain')?></button>
