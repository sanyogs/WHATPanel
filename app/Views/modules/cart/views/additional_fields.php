...
<div class="container inner">
  ...
  <section class="panel panel-default">
		 ...
		 <h3><?= lang('hd_lang.additional_information').' '.'('.$ext.')'?></h3>		 	
		</header> 
        ...
        <div class="col-md-7">
            ...
            <div class="form-group">
                <label class="label-control"><?=lang('hd_lang.domain_transfer')." ".lang('hd_lang.authcode')?> (<?=lang('hd_lang.authcode_requirement')?>)</label>
                <input name="authcode" type="text"  class="form-control" >
                <p><?=lang('hd_lang.auth_epp_required_list')?> .com, .net, .org, .us, .biz, .info, .me, .co, .io, .ca, .tv, .in, .mobi, .cc, .pe, .com.pe, .net.pe, .org.pe,.tech, .top, .party, .loan, .faith and other new gTLD/country code TLD domain transfers</p>
            </div>
            <?php } ?>
            ...
            <div class="form-group">
                <label class="label-control">Accept Section 3 of .IT registrar contract</label>
                <input type="checkbox" name="Accept Section 3 of .IT registrar contract">
                <br>
                <label class="label-control">Accept Section 5 of .IT registrar contract</label>
                <input type="checkbox" name="Accept Section 5 of .IT registrar contract">
                <br>
                <label class="label-control">Accept Section 6 of .IT registrar contract</label>
                <input type="checkbox" name="Accept Section 6 of .IT registrar contract">
                <br>
                <label class="label-control">Accept Section 7 of .IT registrar contract</label>
            ...
            <div class="form-group">
                ...
                <option>Other - Used to record an Incorporated Association number</option>
            ...
            <div class="form-group">
                ...
                <option>Child Care Centre</option>
                ...
                <option>Training Organisation</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <option>Domain name is an Exact Match Abbreviation or Acronym of your Entity or Trading Name</option>
                <option>Close and substantial connection between the domain name and the operations of your Entity</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <label class="label-control">The license number of the registrant's credentials, if applicable</label>
                <input type="text" name="License Number"  class="form-control" required>

                <label class="label-control">The name of the authority from which the registrant receives their professional credentials</label>
                <input type="text" name="Authority"  class="form-control" required>

                <label class="label-control">The URL to an online resource for the authority, preferably, a member search directory</label>
            ...
            <div class="form-group">
                <label class="label-control"> Agree to the .CN <a href="http://www1.cnnic.cn/PublicS/fwzxxgzcfg/201208/t20120830_35735.htm\" target="_blank">Register Agreement</a>
        </label>
            ...
            <div class="form-group">
                ...
                <input name="Birthdate" type="text" class="form-control" placeholder="1900-01-01">
            </div>
            ...
            <div class="form-group">
                ...
                Trustee service allows you to register domains under the name of the trustee if you do not meet the requiremets.
            </div>
            ...
            <div class="form-group">
                ...
                I agree to the <a href="http://www.101domain.com/trustee_agreement.htm" target="_BLANK">Trustee Service Agreement</a>
            </div>

            <div class="form-group">
                <label class="label-control">TRAVEL Usage Agreement</label>
                <input type="checkbox" name="TRAVEL Usage Agreement"><br>
                I agree that .travel domains are restricted to those who are primarily active in the travel industry
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Individuals Birthday" class="form-control" placeholder="YYYY-MM-DD">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Individuals Passport Issue Date" class="form-control" placeholder="YYYY-MM-DD">
            </div>
            ...
            <div class="form-group">
                <label class="label-control">Russian Organizations: Taxpayer Number (ИНН)</label>
                <input type="text" name="Russian Organizations Taxpayer Number 1" class="form-control">
            </div>


            <div class="form-group">
                <label class="label-control">Russian Organizations: Territory-Linked Taxpayer Number (КПП)</label>
                <input type="text" name="Russian Organizations Territory-Linked Taxpayer Number 2" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <option value="010100">Plastics / Petro-Chemicals / Chemicals - Plastics &amp; Plastic Products</option>
                <option value="010200">Plastics / Petro-Chemicals / Chemicals - Rubber &amp; Rubber Products</option>
                <option value="010300">Plastics / Petro-Chemicals / Chemicals - Fibre Materials &amp; Products</option>
                <option value="010400">Plastics / Petro-Chemicals / Chemicals - Petroleum / Coal &amp; Other Fuels</option>
                <option value="010500">Plastics / Petro-Chemicals / Chemicals - Chemicals &amp; Chemical Products</option>
                <option value="020100">Metals / Machinery / Equipment - Metal Materials &amp; Treatment</option>
                <option value="020200">Metals / Machinery / Equipment - Metal Products</option>
                <option value="020300">Metals / Machinery / Equipment - Industrial Machinery &amp; Supplies</option>
                <option value="020400">Metals / Machinery / Equipment - Precision &amp; Optical Equipment</option>
                <option value="020500">Metals / Machinery / Equipment - Moulds &amp; Dies</option>
                <option value="030100">Printing / Paper / Publishing - Printing / Photocopying / Publishing</option>
                <option value="030200">Printing / Paper / Publishing - Paper / Paper Products</option>
                <option value="040100">Construction / Decoration / Environmental Engineering - Construction Contractors</option>
                <option value="040200">Construction / Decoration / Environmental Engineering - Construction Materials</option>
                <option value="040300">Construction / Decoration / Environmental Engineering - Decoration Materials</option>
                <option value="040400">Construction / Decoration / Environmental Engineering - Construction / Safety Equipment &amp; Supplies</option>
                <option value="040500">Construction / Decoration / Environmental Engineering - Decoration / Locksmiths / Plumbing &amp; Electrical Works</option>
                <option value="040600">Construction / Decoration / Environmental Engineering - Fire Protection Equipment &amp; Services</option>
                <option value="040700">Construction / Decoration / Environmental Engineering - Environmental Engineering / Waste Reduction</option>
                <option value="050100">Textiles / Clothing &amp; Accessories - Textiles / Fabric</option>
                <option value="050200">Textiles / Clothing &amp; Accessories - Clothing</option>
                <option value="050300">Textiles / Clothing &amp; Accessories - Uniforms / Special Clothing</option>
                <option value="050400">Textiles / Clothing &amp; Accessories - Clothing Manufacturing Accessories</option>
                <option value="050500">Textiles / Clothing &amp; Accessories - Clothing Processing &amp; Equipment</option>
                <option value="050600">Textiles / Clothing &amp; Accessories - Fur / Leather &amp; Leather Goods</option>
                <option value="050700">Textiles / Clothing &amp; Accessories - Handbags / Footwear / Optical Goods / Personal Accessories</option>
                <option value="060100">Electronics / Electrical Appliances - Electronic Equipment &amp; Supplies</option>
                <option value="060200">Electronics / Electrical Appliances - Electronic Parts &amp; Components</option>
                <option value="060300">Electronics / Electrical Appliances - Electrical Appliances / Audio-Visual Equipment</option>
                <option value="070100">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Kitchenware / Tableware</option>
                <option value="070200">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Bedding</option>
                <option value="070300">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Bathroom / Cleaning Accessories</option>
                <option value="070400">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Household Goods</option>
                <option value="070500">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Wooden / Bamboo &amp; Rattan Goods</option>
                <option value="070600">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Home Furnishings / Arts &amp; Crafts</option>
                <option value="070700">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Watches / Clocks</option>
                <option value="070800">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Jewellery Accessories</option>
                <option value="070900">Houseware / Watches / Clocks / Jewellery / Toys / Gifts - Toys / Games / Gifts</option>
                <option value="080100">Business &amp; Professional Services / Finance - Accounting / Legal Services</option>
                <option value="080200">Business &amp; Professional Services / Finance - Advertising / Promotion Services</option>
                <option value="080300">Business &amp; Professional Services / Finance - Consultancy Services</option>
                <option value="080400">Business &amp; Professional Services / Finance - Translation / Design Services</option>
                <option value="080500">Business &amp; Professional Services / Finance - Cleaning / Pest Control Services</option>
                <option value="080600">Business &amp; Professional Services / Finance - Security Services</option>
                <option value="080700">Business &amp; Professional Services / Finance - Trading / Business Services</option>
                <option value="080800">Business &amp; Professional Services / Finance - Employment Services</option>
                <option value="080900">Business &amp; Professional Services / Finance - Banking / Finance / Investment</option>
                <option value="081000">Business &amp; Professional Services / Finance - Insurance</option>
                <option value="081100">Business &amp; Professional Services / Finance - Property / Real Estate</option>
                <option value="090100">Transportation / Logistics - Land Transport / Motorcars</option>
                <option value="090200">Transportation / Logistics - Sea Transport / Boats</option>
                <option value="090400">Transportation / Logistics - Moving / Warehousing / Courier &amp; Logistics Services</option>
                <option value="090500">Transportation / Logistics - Freight Forwarding</option>
                <option value="100100">Office Equipment / Furniture / Stationery / Information Technology - Office / Commercial Equipment &amp; Supplies</option>
                <option value="100200">Office Equipment / Furniture / Stationery / Information Technology - Office &amp; Home Furniture</option>
                <option value="100300">Office Equipment / Furniture / Stationery / Information Technology - Stationery &amp; Educational Supplies</option>
                <option value="100400">Office Equipment / Furniture / Stationery / Information Technology - Telecommunication Equipment &amp; Services</option>
                <option value="100500">Office Equipment / Furniture / Stationery / Information Technology - Computers / Information Technology</option>
                <option value="110100">Food / Flowers / Fishing &amp; Agriculture - Food Products &amp; Supplies</option>
                <option value="110200">Food / Flowers / Fishing &amp; Agriculture - Beverages / Tobacco</option>
                <option value="110300">Food / Flowers / Fishing &amp; Agriculture - Restaurant Equipment &amp; Supplies</option>
                <option value="110400">Food / Flowers / Fishing &amp; Agriculture - Flowers / Artificial Flowers / Plants</option>
                <option value="110500">Food / Flowers / Fishing &amp; Agriculture - Fishing</option>
                <option value="110600">Food / Flowers / Fishing &amp; Agriculture - Agriculture</option>
                <option value="120100">Medical Services / Beauty / Social Services - Medicine &amp; Herbal Products</option>
                <option value="120200">Medical Services / Beauty / Social Services - Medical &amp; Therapeutic Services</option>
                <option value="120300">Medical Services / Beauty / Social Services - Medical Equipment &amp; Supplies</option>
                <option value="120400">Medical Services / Beauty / Social Services - Beauty / Health</option>
                <option value="120500">Medical Services / Beauty / Social Services - Personal Services</option>
                <option value="120600">Medical Services / Beauty / Social Services - Organizations / Associations</option>
                <option value="120700">Medical Services / Beauty / Social Services - Information / Media</option>
                <option value="120800">Medical Services / Beauty / Social Services - Public Utilities</option>
                <option value="120900">Medical Services / Beauty / Social Services - Religion / Astrology / Funeral Services</option>
                <option value="130100">Culture / Education - Music / Arts</option>
                <option value="130200">Culture / Education - Learning Instruction &amp; Training</option>
                <option value="130300">Culture / Education - Elementary Education</option>
                <option value="130400">Culture / Education - Tertiary Education / Other Education Services</option>
                <option value="130500">Culture / Education - Sporting Goods</option>
                <option value="130600">Culture / Education - Sporting / Recreational Facilities &amp; Venues</option>
                <option value="130700">Culture / Education - Hobbies / Recreational Activities</option>
                <option value="130800">Culture / Education - Pets / Pets Services &amp; Supplies</option>
                <option value="140101">Dining / Entertainment / Shopping / Travel - Restaurant Guide - Chinese</option>
                <option value="140102">Dining / Entertainment / Shopping / Travel - Restaurant Guide - Asian</option>
                <option value="140103">Dining / Entertainment / Shopping / Travel - Restaurant Guide - Western</option>
                <option value="140200">Dining / Entertainment / Shopping / Travel - Catering Services / Eateries</option>
                <option value="140300">Dining / Entertainment / Shopping / Travel - Entertainment Venues</option>
                <option value="140400">Dining / Entertainment / Shopping / Travel - Entertainment Production &amp; Services</option>
                <option value="140500">Dining / Entertainment / Shopping / Travel - Entertainment Equipment &amp; Facilities</option>
                <option value="140600">Dining / Entertainment / Shopping / Travel - Shopping Venues</option>
                <option value="140700">Dining / Entertainment / Shopping / Travel - Travel / Hotels &amp; Accommodation</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <option value="HKSARG">Hong Kong Special Administrative Region Gov\'t Dept</option>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Organizations Name in Chinese" class="form-control">
            </div>

 
            <div class="form-group">
                <label class="label-control">Organizations: Document Number</label>
                <input type="text" name="Organizations Document Number" class="form-control">
            </div>


            <div class="form-group">
                <label class="label-control">Organizations: Issuing Country</label>
                <input type="text" name="Organizations Issuing Country" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Identification Number" class="form-control">
                 For Sweedish Residents: Personal or Organization Number; For residents of other countries: Civic Registration Number, Company Registration Number or Passport Number
            </div>
            ...
            <input type="submit" class="btn btn-success pull-right" value="<?=lang('hd_lang.submit')?>">
            </div>
         </div>
         </div>
         </form>
