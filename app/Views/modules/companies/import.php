<div class="box">
          ...
          echo form_open(base_url().'companies/import_clients', $attributes); ?>  
                ...
                <table id="table-rates" class="table table-striped b-t">
                    <thead>
                    <tr>
                        <th><?=lang('hd_lang.first_name')?></th> 
                        <th><?=lang('hd_lang.last_name')?></th> 
                        <th><?=lang('hd_lang.company_name')?></th>
                        <th><?=lang('hd_lang.email')?></th> 
                        <th><?=lang('hd_lang.address_line_1')?></th> 
                        <th><?=lang('hd_lang.address_line_2')?></th> 
                        <th><?=lang('hd_lang.city')?></th>
                        <th><?=lang('hd_lang.country')?></th> 
                        <th><?=lang('hd_lang.phone')?></th> 
