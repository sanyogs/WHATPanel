               ...
               <tr>
                   ...
                   <td>
                    <div class="d-flex align-items-center gap-2">
                       <a href="<?=base_url()?>accounts/account/<?=$order->id?>"
                           class="btn btn-sm btn-success d-flex align-items-center text-light"><?=lang('hd_lang.view')?> </a>
                       <a href="<?=base_url()?>accounts/manage/<?=$order->id?>"
                           class="btn btn-sm btn-warning d-flex align-items-center text-light"><?=lang('hd_lang.manage')?> </a>
                    </div>
                   </td>
                   <?php } ?>
               </tr>
