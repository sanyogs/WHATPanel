            ...
            <div class="tab-content">
             ...
             <input type="text" name="first_name" value="" class="input-sm form-control" required tabindex="1">
                            ...
                            <div class="form-group my-3">
                                ...
                                <input type="text" name="last_name" value="" class="input-sm form-control" required tabindex="3">
                            </div>

                            <div class="form-group my-3">
                                <label><?= lang('hd_lang.vat') ?> <?= lang('hd_lang.number') ?> / <?= lang('hd_lang.gst') ?> <?= lang('hd_lang.number') ?> </label>
                                <input type="text" value="" name="VAT" class="input-sm form-control" tabindex="5">
                            </div>

                            <div class="form-group my-3">
                                <label><?= lang('hd_lang.mobile_phone') ?> <span class="text-danger">*</span></label>
                                <input type="text" name="company_mobile" class="input-sm form-control" tabindex="7" required value="">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group my-3">
                                ...
                                <input type="text" name="middle_name" value="" class="input-sm form-control" tabindex="2">
                            </div>
                            ...
                            <div class="form-group my-3">
                                ...
                                <input type="text" name="username" class="input-sm form-control" required tabindex="10" value="">
                            </div>
