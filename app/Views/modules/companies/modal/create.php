...
<div class="tab-content">
    <div class="tab-pane fade in active show " id="tab-client-general">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group my-3">
                    ...
                    <input type="text" name="first_name" pattern="[a-zA-Z]+" value="" class="input-sm form-control" required tabindex="1">
                </div>

                <div class="form-group my-3">
                    <label><?= lang('hd_lang.last_name') ?><span class="text-danger">*</span></label>
                    <input type="text" name="last_name" pattern="[a-zA-Z]+" value="" class="input-sm form-control" required tabindex="3">
                </div>

                <div class="form-group my-3">
                    <label><?= lang('hd_lang.vat') ?> <?= lang('hd_lang.number') ?> / <?= lang('hd_lang.gst') ?> <?= lang('hd_lang.number') ?> </label>
                    <input type="text" value="" name="VAT" pattern="[a-zA-Z]+" class="input-sm form-control" tabindex="5">
                </div>

                <div class="form-group my-3">
                    <label><?= lang('hd_lang.mobile_phone') ?> <span class="text-danger">*</span></label>
                    <input type="tel" name="company_mobile" pattern="[0-9]+" class="input-sm form-control" required tabindex="7" value="">
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group my-3">
                    ...
                    <input type="text" name="middle_name" pattern="[a-zA-Z]+" value="" class="input-sm form-control" tabindex="2">
                </div>

                <div class="form-group my-3">
                    <label><?= lang('hd_lang.company_name') ?><span class="text-danger">*</span></label>
                    <input type="text" name="company_name" pattern="[a-zA-Z]+" class="input-sm form-control" required tabindex="4" value="">
                </div>

                <div class="form-group my-3">
                    <label><?= lang('hd_lang.phone') ?> </label>
                    <input type="text" name="company_phone" pattern="[0-9]+" class="input-sm form-control" tabindex="6" value="">
                </div>

                <div class="form-group my-3">
                    <label><?= lang('hd_lang.fax') ?> </label>
                    <input type="text" name="company_fax" pattern="[0-9]+" class="input-sm form-control" tabindex="8" value="">
                </div>

                <div class="form-group my-3">
                    <label><?= lang('hd_lang.username') ?> <span class="text-danger">*</span></label>
                    <input type="text" name="username" pattern="[a-zA-Z]+" class="input-sm form-control" required tabindex="10" value="">
                </div>

                <div class="form-group my-3">
                    <label><?= lang('hd_lang.confirm_password') ?> </label>
                    <input type="password" name="confirm_password" class="input-sm form-control" tabindex="12">
                </div>
        ...
        <div class="form-group my-3">
            ...
            <textarea name="notes" class="form-control ta common-input" pattern="[a-zA-Z0-9\s]+" style='height: unset !important;'></textarea>
        </div>
    ...
    <div class="tab-pane fade in " id="tab-client-contact">
        ...
        <div class="form-group my-3">
            ...
            <textarea name="company_address1" class="form-control ta common-input" style='height: unset !important;'></textarea>
        </div>
        <div class="form-group my-3">
            <label><?= lang('hd_lang.address2') ?></label>
            <textarea name="company_address2" class="form-control ta common-input" style='height: unset !important;'></textarea>
        </div>
        <div class="row">
...
<script>
    ...
    form.addEventListener('submit', (e) => {
        ...
        const alphabeticInputs = document.querySelectorAll('input[type="text"][pattern]');
