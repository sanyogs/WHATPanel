...
<div class="modal-dialog sm-modal">
	<div class="modal-content w-100">
		...
		<div class="modal-body">
			<p>
				<?= lang('hd_lang.delete_slider_warning') ?>
			</p>
		...
		<div class="modal-footer"> <a href="#" class="btn btn-default" data-dismiss="modal">
			...
			<button type="submit" class="btn btn-<?= $custom_name_helper->getconfig_item('theme_color') ?>">
				<?= lang('hd_lang.delete_button') ?>
			</button>
			</form>
		</div>
	</div>
