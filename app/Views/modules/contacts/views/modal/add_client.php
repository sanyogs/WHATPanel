<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title"><?=lang('hd_lang.add_contact')?></h4>
		</div><?php
		...
		<div class="modal-body">
			 ...
			 <div class="form-group">
				<label class="col-lg-4 control-label"><?=lang('hd_lang.full_name')?> <span class="text-danger">*</span></label>
				<div class="col-lg-8">
				...
				<div class="form-group">
				<label class="col-lg-4 control-label"><?=lang('hd_lang.password')?> </label>
				<div class="col-lg-8">
					<input type="password" class="form-control" value="<?=set_value('password')?>" name="password">
				</div>
				</div>
				<div class="form-group">
				<label class="col-lg-4 control-label"><?=lang('hd_lang.confirm_password')?> </label>
				<div class="col-lg-8">
				...
				<div class="form-group">
					<label class="col-lg-4 control-label"><?=lang('hd_lang.email_contact')?></label>
					<label class="">
		...
		<button type="submit" class="btn btn-<?=config_item('theme_color');?>"><?=lang('hd_lang.add_contact')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
