            ...
            <div class="col-sm-6">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <button type="submit" class="btn btn-success pull-right"><?= lang('hd_lang.continue') ?></button>
                        </div>
                        <div class="col-md-1">
                            <a href="<?= base_url() ?>companies/create" class="btn btn-default btn-sm" data-toggle="ajaxModal" title="<?= lang('hd_lang.new_company') ?>" data-placement="bottom"><i class="fa fa-plus"></i> <?= lang('hd_lang.new_client') ?></a>
                        </div>
                    </div>
                </div>
            </div>
