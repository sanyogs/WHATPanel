<div class="modal-dialog modal-lg">
	<div class="modal-content">
					...
					<table class="table table-bordered table-striped">		
						...
						<tbody>
								<?php foreach($order as $item) { 
									...
									<td><?=$item->domain?></td>
									<td><input type="text" value="<?=$item->authcode?>" name="authcode[]" <?php if($item->item_name != lang('hd_lang.domain_transfer')) { ?> readonly <?php } ?>> </td>
		...
		<button type="submit" class="btn btn-<?=config_item('theme_color');?>"><?=lang('hd_lang.activate')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
