...
<section id="add-server-modal" class="clm-layout">
	<div class="modal-dialog modal-xl mx-auto">
		<div class="modal-content nh-modal-content w-100">
			...
			echo form_open(base_url('hosting/add_hosting'), $attributes); ?>
			<div class="nh-modal-body">
				<div class="nh-data-wrap">
					<div class="nh-data-row-1">
						<input type="hidden" name="quantity" value="1">
						<input type="hidden" name="cat_type" value="hosting">
						<input type="hidden" name="r_url" id="r_url" value="<?php echo base_url('hosting/index/hosting'); ?>" />
						<div class="nh-category-select-wrap">
							...
							<div class="nh-category-input-wrap">
								<select id="category" name="category" required>
									<?php
									$categories = $db->table('hd_categories')->where(array('parent' => 9))->get()->getResult();
						...
						<div class="nh-category-select-wrap">
							...
							<div class="nh-category-input-wrap">
						<input type="text" placeholder="Add hosting name" class="hs-modal-input" id="item_name" name="item_name" required/>
							</div>
						</div>
							<!-- <div class="nh-category-input-wrap nh-tax-rate">
								<select id="item_tax_rate" name="item_tax_rate" required>
									<?//php
									// $taxes = $db->table('hd_tax_rates')->get()->getResult();
						...
						<div class="nh-category-select-wrap">
							...
							<div class="nh-category-input-wrap">
								<input type="text" placeholder="01" class="hs-modal-input" name="order_by" id="order_by" required/>
							</div>
						</div>
					</div>
					<div class="nh-data-row-2">
						<div class="nh-category-select-wrap">
							...
							<div class="nh-category-input-wrap">
								<textarea cols="85" rows="20" class="hs-modal-input" placeholder="Eg: 10GB Storage, 20GB Bandwidth, Unlimited E-mails..." name="item_features" required></textarea>
							</div>
						</div>
						<div class="nh-noflex-wrap">
							...
							<div class="nh-input-btnwrap">
								<div class="form-check form-switch input-btn-div">
									<input type="hidden" name="require_domain" value="on">
    		<input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="require_domain" checked disabled/>
								</div>
							</div>
						</div>
						<div class="nh-noflex-wrap">
							<div class="nh-category-title">
								<p>Reseller Package</p>
							</div>
							<div class="nh-input-btnwrap">
								<div class="form-check form-switch input-btn-div">
						<input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="reseller_package"/>
								</div>
							</div>
						</div>
						<div class="nh-noflex-wrap">
							...
							<div class="nh-input-btnwrap">
								<div class="form-check form-switch input-btn-div">
			<input class="form-check-input" type="checkbox" role="switch" id="item_tax_rate" name="item_tax_rate" />
								</div>
							</div>
						</div>
					</div>
					<div class="nh-data-row-3">
						<div class="nh-noflex-wrap">
							...
							<div class="nh-input-btnwrap">
								<div class="form-check form-switch input-btn-div">
									<input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="display" />
								</div>
							</div>
						</div>
						<div class="nh-noflex-wrap">
							...
							<div class="nh-input-btnwrap">
								<div class="form-check form-switch input-btn-div">
									<input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="create_account" />
								</div>
							</div>
						</div>
						<div class="nh-noflex-wrap">
							<div class="nh-category-title">
								<p>Allow Upgrade/Downgrade</p>
							</div>
							<div class="nh-input-btnwrap">
								<div class="form-check form-switch input-btn-div">
									<input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="allow_upgrade" />
								</div>
							</div>
						</div>
						<div class="nh-noflex-wrap">
							<div class="nh-category-title">
								<p>Change Renewal Price when Package changes</p>
							</div>
							<div class="nh-input-btnwrap">
								<div class="form-check form-switch input-btn-div">
									<input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="price_change" />
								</div>
							</div>
						</div>
					</div>
					<div class="nh-data-table-wrap table-responsive">
						...
						<table class="nh-add-pricing">
							...
							<td><input type="text" style="border: none; text-align: center;" name="monthly_payments[]" id="monthly_payments<?= $i; ?>" placeholder="00.00" class="hs-modal-input monthly-payment" data-row="<?= $i; ?>" oninput="validateInput(this)" required/></td>
							<td><input type="text" style="border: none; text-align: center;" name="quarterly_payments[]" id="quarterly_payments<?= $i; ?>" placeholder="00.00" class="hs-modal-input quarterly-payment" readonly oninput="validateInput(this)" required/></td>
							<td><input type="text" style="border: none; text-align: center;" name="semi_annually_payments[]" id="semi_annually_payments<?= $i; ?>" placeholder="00.00" class="hs-modal-input semi-annually-payment" readonly oninput="validateInput(this)" required/></td>
							<td><input type="text" style="border: none; text-align: center;" name="annually_payments[]" id="annually_payments<?= $i; ?>" placeholder="00.00" class="hs-modal-input annually-payment" readonly oninput="validateInput(this)" required/></td>
							<td><input type="text" style="border: none; text-align: center;" name="biennially_payments[]" id="biennially_payments<?= $i; ?>" placeholder="00.00" class="hs-modal-input biennially-payment" readonly oninput="validateInput(this)" required/></td>
							<td><input type="text" style="border: none; text-align: center;" name="triennially_payments[]" id="triennially_payments<?= $i; ?>" placeholder="00.00" class="hs-modal-input triennially-payment" readonly oninput="validateInput(this)" required/></td>
							</tr>
							<?php $i++;
															   } ?>
						</table>
		...
		<!-- JavaScript code to calculate and populate other payment frequencies -->
		<script>
