...
<section id="add-new-hosting-modalwrap">
	<div class="modal-dialog nh-modal-adjuster modal-xl mx-auto">
		<div class="modal-content nh-modal-content w-100">
			...
			echo form_open(base_url('hosting/edit_service'), $attributes); ?>
				...
				<div class="nh-data-wrap">
					<div class="nh-data-row-1">
						...
						<div class="nh-category-select-wrap">
							...
							<div class="nh-category-input-wrap">
								<input type="text" class="hs-modal-input" value="<?= $item->item_name ?>" name="item_name" required />
							</div>
						</div>
						<div class="nh-category-select-wrap">
							<div class="nh-category-title">
							...
							<div class="nh-category-input-wrap">
								<input type="text" id="order_by" value="<?= $item->order_by ?>" name="order_by" class="hs-modal-input" />
					...
					<div class="nh-data-row-2">
						<div class="nh-category-select-wrap">
							...
							<div class="nh-category-input-wrap">
								<textarea name='item_features' cols="85" rows="20" class="hs-modal-input" value='<?= $item->item_features ?>'><?= $item->item_features ?>></textarea>
							</div>
						</div>
						<div class="nh-noflex-wrap">
							...
							<div class="nh-input-btnwrap">
								<div class="form-check form-switch input-btn-div">
									<input type="hidden" value="on" name="require_domain" />
				<input name="require_domain" class="form-check-input" id="flexSwitchCheckDefault" type="checkbox" <?php if ($item->require_domain == 'Yes') {
...
<input name="display" class="form-check-input" type="checkbox" <?php if ($item->display == 'Yes') { echo "checked=\"checked\"";} ?> />
								</div>
							</div>
						</div>
						<div class="nh-noflex-wrap">
								...
								<div class="nh-input-btnwrap">
									<div class="form-check form-switch input-btn-div">
								<input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" <?php if($item->item_tax_rate == 'Yes'){ echo "checked=\"checked\""; } ?> name="item_tax_rate"/>
									</div>
								</div>
							</div>
					</div>
					<div class="nh-data-table-wrap">
						<div class="nh-category-title service-account-switch">
							<p>Account Option</p>
							<div class="form-check form-switch input-btn-div">
			<input name="account_option" class="form-check-input" type="checkbox" role="switch" id="add-service-table-check" <?php if ($item->account_option == 'Yes') { echo "checked=\"checked\"";} ?>/>
							</div>
						</div>
						<div class="d-flex nh-data-row-1 switch-display" style="display:none;">
							<div class="nh-category-select-wrap switch-display">
								...
								<div class="nh-category-input-wrap">
									<input type="text" value="<?= $item->setup_fee ?>" name="setup_fee" class="hs-modal-input" />
								</div>
							</div>
							<div class="nh-category-select-wrap switch-display">
								<div class="nh-category-title">
								...
								<div class="nh-category-input-wrap">
									<input type="text" id="price" value="<?= $item->unit_cost ?>" name="unit_cost" class="hs-modal-input" />
								</div>
							</div>
						</div>
						<div class="table-responsive">
							<table class="nh-add-pricing service-table">
								<tr>
									...
									<th><?= lang('hd_lang.no_of_payments') ?></th>
								...
								<?php
								// $currencies = $dbName->table('hd_currencies')->whereIn('code', ['INR', 'USD', 'EUR'])->get()->getResult();
								...
								// echo "<pre>";print_r($matched_currencies);die;
		...
		<td><input type="text" class="form-control" value="<?= $currency->monthly ?>" name="monthly_payments[]" oninput="validateInput(this)"></td>
										
<td><input type="text" class="form-control" value="<?= $currency->monthly_payments ?>" name="monthly[]" oninput="validateInput(this)"></td>
									
<td><input type="text" class="form-control" value="<?= $currency->quarterly ?>" name="quarterly_payments[]" oninput="validateInput(this)"></td>
										
<td><input type="text" class="form-control" value="<?= $currency->quarterly_payments ?>" name="quarterly[]" oninput="validateInput(this)"></td>
										
<td><input type="text" class="form-control" value="<?= $currency->semi_annually ?>" name="semi_annually_payments[]" oninput="validateInput(this)"></td>

<td><input type="text" class="form-control" value="<?= $currency->semi_annually_payments ?>"  name="semi_annually[]" oninput="validateInput(this)"></td>
										
<td><input type="text" class="form-control" value="<?= $currency->annually ?>" name="annually_payments[]"></td>
										
<td><input type="text" class="form-control" value="<?= $currency->annually_payments ?>" name="annually[]" oninput="validateInput(this)"></td>
										
<td><input type="text" class="form-control" value="<?= $currency->biennially ?>" name="biennially_payments[]" oninput="validateInput(this)"></td>
									
<td><input type="text" class="form-control" value="<?= $currency->biennially_payments ?>" name="biennially[]" oninput="validateInput(this)"></td>
										
<td><input type="text" class="form-control" value="<?= $currency->triennially ?>" name="triennially_payments[]" oninput="validateInput(this)"></td>
										
<td><input type="text" class="form-control" value="<?= $currency->triennially_payments ?>" name="triennially[]" oninput="validateInput(this)"></td>
									</tr>
								<?php $i++;
								} ?>
							</table>
						</div>
						<div class="d-flex gap-5" style="margin-top: 2%;">
...
<input name="allow_upgrade" <?php if ($item->allow_upgrade == 'Yes') { echo "checked=\"checked\""; } ?> class="form-check-input switch-cus m-1" type="checkbox" role="switch" id="flexSwitchCheckDefault" />
									</div>
								</div>
							</div>
						</div>
...
<input name="price_change" <?php if ($item->allow_upgrade == 'Yes') { echo "checked=\"checked\""; } ?> class="form-check-input switch-cus m-1" type="checkbox" role="switch" id="flexSwitchCheckDefault" />
									</div>
								</div>
							</div>
							<div class="nh-noflex-wrap switch-display d-flex d-none">
				...
				<input id="create_account" class="form-check-input switch-cus" type="checkbox" name="create_account" style="margin-top:9%" />
									</div>
								</div>
							</div>
						</div>
...
// Check initial state of checkbox when page loads
if (checkbox.checked) {
  $('.service-table').addClass('d-block');
  $('.switch-display').removeClass('d-none');
  $('.switch-ud').removeClass('d-none');
