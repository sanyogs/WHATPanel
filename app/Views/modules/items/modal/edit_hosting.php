        ...
        <div class="modal-content nh-modal-content w-100">
            <div class="nh-modal-header">
                <div class="nh-modal-title">
                    <h3>Edit Hosting</h3>
                    <p>Fill below options to edit Hosting</p>
                </div>
             ...
             echo form_open(base_url('hosting/edit_hosting'),$attributes); ?>
                    ...
                    <div class="nh-data-wrap">
                        <div class="nh-data-row-1">
                            ...
                            <div class="nh-category-select-wrap">
                                ...
                                <div class="nh-category-input-wrap">
                                    <input type="text" placeholder="Enter Item name" class="hs-modal-input" id="item_name" name="item_name" value="<?=$item->item_name?>" />
                                </div>
                            </div>
                            <div class="nh-category-select-wrap">
                                <div class="nh-category-title">
                                ...
                                <div class="nh-category-input-wrap">
                                    <input type="text" placeholder="Enter Qunatity" class="hs-modal-input" name="order_by" id="order_by" value="<?=$item->order_by?>" oninput="validateInput(this)"/>
                                </div>
                            </div>
                        </div>
                        <div class="nh-data-row-2">
                            ...
                            <div class="nh-noflex-wrap">
                                ...
                                <div class="nh-input-btnwrap">
                                    <div class="form-check form-switch input-btn-div">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" <?php if($item->reseller_package == 'Yes'){ echo "checked=\"checked\""; } ?> name="reseller_package" />
                                    </div>
                                </div>
                            </div>
							<div class="nh-noflex-wrap">
                        ...
                        <div class="nh-data-row-3">
                            <div class="nh-noflex-wrap">
                                ...
                                <div class="nh-input-btnwrap">
                                    <div class="form-check form-switch input-btn-div">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="display" <?php if($item->display == 'Yes'){ echo "checked=\"checked\""; } ?> name="display">
                                    </div>
                                </div>
                            </div>
                            <div class="nh-noflex-wrap">
                                ...
                                <div class="nh-input-btnwrap">
                                    <div class="form-check form-switch input-btn-div">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" <?php if($item->create_account == 'Yes'){ echo "checked=\"checked\""; } ?> name="create_account" />
                                    </div>
                                </div>
                            </div>
                            <div class="nh-noflex-wrap">
                                ...
                                <div class="nh-input-btnwrap">
                                    <div class="form-check form-switch input-btn-div">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" <?php if($item->allow_upgrade == 'Yes'){ echo "checked=\"checked\""; } ?> name="allow_upgrade" />
                                    </div>
                                </div>
                            </div>
                            <div class="nh-noflex-wrap">
                                ...
                                <div class="nh-input-btnwrap">
                                    <div class="form-check form-switch input-btn-div">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" <?php if($item->price_change == 'Yes'){ echo "checked=\"checked\""; } ?> name="price_change" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="nh-modal-footer">
                    <div class="nh-footer-btn-wrap">
                        ...
                        <button type="submit"><div class="nh-modal-addbtn">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
