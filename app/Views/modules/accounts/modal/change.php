 ...
 <div class="modal-dialog my-modal">
     ...
     <div class="modal-content">
         <div class="modal-header">
             ...
             <h4 class="modal-title"><?=lang('hd_lang.upgrade_account')?></h4>
         </div>
             ...
             <div class="row">
                ...
                foreach($packages as $plan) { ?>
                    ...
                    ?>
                     <div class="columns">
                         <ul class="price">
                             <li class="<?= ($count == 2) ? 'highlight' : 'header' ?>"><?=ucfirst($plan->item_name)?>
                             </li>
                             <li class="grey">
                            ...
                            if(count($features) > 0) { foreach($features as $feature ) { ?>
                             <li><?=$feature?></li>
                             <?php } } ?>
                             <li class="grey"><a href="<?=base_url()?>accounts/show_options/<?=$plan->item_id?>"
                                     class="btn btn-success">Select</a></li>
                         </ul>
                     </div>
