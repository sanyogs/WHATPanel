...
<div class="modal-dialog my-modal">
	<div class="modal-content">
		...
		<h4 class="modal-title"><?=lang('hd_lang.cancel_account')?></h4>
		</div><?php
		...
		<input type="hidden" name="id" value="<?=$item->id?>" style="display: none;">
				<div class="form-group">
						...
						<div class="col-lg-5"><label class="switch">
									<input type="hidden" value="off" name="delete_controlpanel" style="display:none;" />
				...
				<div class="nh-noflex-wrap">
					...
					<div class="nh-input-btnwrap">
					  ...
					  <input type="hidden" value="off" name="credit_account" style="display: none;"> 
		...
		<button <?=($custom->getconfig_item('demo_mode') == 'TRUE') ? 'disabled' : ''?> type="submit" class="btn btn-<?=$custom->getconfig_item('theme_color');?>"><?=lang('hd_lang.cancel_account')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
