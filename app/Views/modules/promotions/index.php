    ...
    <div class="hs-topbar-wrap">
      ...
      <div class="hs-search-wrap">
        <div class="hs-InputWrap">
          ...
          <form method='get' action="<?php echo base_url('promotions'); ?>" id="searchForm" style="display:flex;">
            <input type="text" name="search" placeholder="Search for Code" style="margin-right: 10px;"/>
			<a href="<?php echo base_url('promotions'); ?>" class="btn new-hosting-div bg-danger clrBtn" style="padding: 7px;">Clear</a>
          </form>
        </div>
        <a href="<?= base_url('promotions/add_promotion') ?>" data-toggle="ajaxModal" class="new-hosting-div">
          <span>
    ...
    <div class="hs-table-wrap">
      <div class="tableInfoHead">
        <div class="showEntriesWrap">
          <span>Show</span>
          <form action="<?php echo base_url('promotions'); ?>" method="get">
      ...
      <div class="hs-table-overflow">
        <table class="hs-table">
          <tr>
            <th><?= lang('hd_lang.code') ?></th>
            <th><?= lang('hd_lang.value') ?></th>
            <th><?= lang('hd_lang.type') ?></th>
            <th><?= lang('hd_lang.start_date') ?></th>
            <th><?= lang('hd_lang.end_date') ?></th>
            <th><?= lang('hd_lang.use_date') ?></th>
          ...
          <?php foreach ($promotions as $promo) { ?>
            <tr>
              <td><?= $promo->code ?></td>
              <td><?= $promo->value ?></td>
              <td><?= ($promo->type == 1) ? lang('hd_lang.amount') : lang('hd_lang.percentage') ?></td>
              <td><?= $promo->start_date ?></td>
              <td><?= $promo->end_date ?></td>
              <td><?= ($promo->use_date == 1) ? lang('hd_lang.yes') : lang('hd_lang.no') ?></td>
              <td><?= $promo->description ?></td>
              <td>
                <div class="tableIcon">
                  <a href="<?= base_url() ?>promotions/edit/<?= $promo->id ?>" data-toggle="ajaxModal" class="edit-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
			...
			<a href="<?= base_url() ?>promotions/delete/<?= $promo->id ?>" data-toggle="ajaxModal" data-bs-target="#delete-modal-div" class="edit-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
