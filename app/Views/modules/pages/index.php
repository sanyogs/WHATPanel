    ...
    <div class="hs-table-wrap">
      <div class="tableInfoHead">
        <div class="showEntriesWrap">
          <span>Show</span>
           <form action="<?php echo base_url('pages'); ?>" method="get">
      ...
      <div class="hs-table-overflow">
		...
		<?php //echo"<pre>";print_r($pages);die;
          ...
          <tr>
            ...
            <td>
			<a href="<?= $helper->post_url($page) ?>" target="_blank"><?= $helper->post_title($page) ?></a></td>
            <td>
				<?php if ($page->faq == 1) {
					echo '<span class="label label-default">' . lang('hd_lang.faq') . '</span>';
				} ?>
								<?php if ($page->knowledge == 1) {
					echo '<span class="label label-default">' . lang('hd_lang.knowledgebase') . '</span>';
				} ?>
								<?php if ($page->faq == 0 && $page->knowledge == 0) {
					echo '<span class="label label-default">' . lang('hd_lang.page') . '</span>';
				} ?>
			</td>
            <td>
				<?= $helper->post_status($page) == 1 ? '<span class="label label-success"  data-title="' . lang("active") . '">' . lang("active") . '</span>' : '<span class="label label-danger" data-title="' . lang("hidden") . '">' . lang("hidden") . '</span>' ?>
			</td>
            <td>
              <div class="tableIcon">
                <a href="<?= base_url('pages/edit/' . $helper->post_id($page)) ?>" data- toggle="ajaxModal" >
					  <svg
						   xmlns="http://www.w3.org/2000/svg"
						   width="16"
						   height="16"
                  ...
                  <a onClick="javascript:return confirm('<?= lang('hd_lang.delete_confirm') ?>');" href="<?= base_url('pages/deleted/' . $helper->post_id($page)) ?>" data-bs-toggle="modal"
					 data-bs-target="#delete-modal-div">
					  <svg
						   xmlns="http://www.w3.org/2000/svg"
						   width="16"
						   height="16"
