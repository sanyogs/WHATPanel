...
<div class="box">
  ...
  <div class="box-header b-b">
    ...
    <?php if ($this->uri->segment(3)) { ?>
      <a href="<?= base_url() ?>reports/paymentspdf/<?= strtotime($start_date) ?>/<?= strtotime($end_date) ?>"
          ...
          <tbody>
            ...
            foreach ($payments as $key => $tr) { ?>
              <tr>
                ...
                <td><a
                    href="<?= base_url() ?>invoices/view/<?= $tr->invoice ?>"><?= Invoice::view_by_id($tr->invoice)->reference_no; ?></a>
                </td>
