...
<div class="box">
    <div class="box-header b-b">
        ...
        <a href="<?= base_url() ?>reports/invoicespdf/<?= strtotime($start_date) ?>/<?= strtotime($end_date) ?>/<?= $report_by ?>"
            class="btn btn-dark btn-sm pull-right"><i class="fa fa-file-pdf-o"></i>
            <?= lang('hd_lang.pdf') ?>
        </a>
        <?php } ?>
                    ...
                    <address class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-control" name="report_by">
                                ...
                                <option value="InvoiceDueDate"
                                    <?= ($report_by == 'InvoiceDueDate') ? 'selected="selected"' : ''; ?>>
                                    <?= lang('hd_lang.invoice') ?>
                                    <?= lang('hd_lang.due_date') ?>
                                </option>
                            </select>
                        </div>
            ...
            <div class="rep-container">
                <div class="page-header text-center">
                    <h3 class="reports-headerspacing">
                        <?= lang('hd_lang.invoices_report') ?>
                    </h3>
                    <h5><span>From</span>&nbsp;
                        <?= $start_date ?>&nbsp;<span>To</span>&nbsp;
                        <?= $end_date ?>
                    </h5>
                </div>
          ...
          foreach ($invoices as $key => $invoice) {
            ...
            ?>
                    <tr>
                        ...
                        <td><a
                                href="<?= base_url() ?>companies/view/<?= $invoice->client ?>"><?= Client::view_by_id($invoice->client)->company_name ?></a>
                        </td>
