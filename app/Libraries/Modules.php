...
class Modules {
    ...
    {  
         ...
         return $this->pluginModel->set_status($module, 1);      
    }
    ...
    {  
        return $this->pluginModel->set_status($module, 0); 
    }
    ...
    {
        if( ! $modules = $this->pluginModel->get_plugins())
        {
            return FALSE;
        }
    ...
    public function update_module_headers($module)
    {
        ...
        { 
            ...
            elseif($this->pluginModel->update_plugin_info($module, $arr))
            {  
