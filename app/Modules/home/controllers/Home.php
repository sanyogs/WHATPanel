...
class Home extends WhatPanel
{
    ...
    {	
        ...
        $data['content'] = view('custom/pages/home'); // Load the "home" view
        return view($helper->getconfig_item('active_theme').'/pages/home', $data); // Load the "main" layout and pass data
    }
