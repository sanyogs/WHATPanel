...
namespace App\Modules\Layouts\Libraries;

use Modules\Layouts\Config;

class Template
{
    private $theme = null;
    private $layout = false;
    private $layoutSubdir = '';
    private $title = '';
    private $_metadata = [];
    private $partials = [];
    ...
    private $parserBodyEnabled = true;
    ...
    {
        $this->config = config(\Config\Template::class);
