...
class Contact extends WhatPanel
{
    ...
    function index()
    {
        ...
        if ($this->form_validation->run($this)) {
            ...
            if ($this->email->send(FALSE)) {
                $this->session->set_flashdata('message', lang('hd_lang.message_sent'));
            } else {
                $this->session->set_flashdata('message', lang('hd_lang.message_not_sent'));
                //$this->session->set_flashdata('message', lang('hd_lang.message_not_sent') . "<p>". $this->email->print_debugger(array('headers', 'subject', 'body')). "</p>");
            }
            redirect('contact');
        ...
        $this->template->title(lang('hd_lang.contact'));
