...
$routes->group('pages', ['filter' => 'sessionsCheck','namespace' => 'App\Modules\pages\controllers'], function ($subroutes) {
	$subroutes->get('web_hosting', 'Pages::page/web_hosting');
	$subroutes->get('faq', 'Pages::page/faq');
	$subroutes->get('new_page', 'Pages::page/new_page');
	$subroutes->get('_can_i_host_wordpress_on_shared_hosting', 'Pages::page/_can_i_host_wordpress_on_shared_hosting');
	$subroutes->get('web_hosting', 'Pages::page/web_hosting');
	$subroutes->get('is_.com_domain_still_the_best', 'Pages::page/is_.com_domain_still_the_best');
	$subroutes->get('do_i_need_a_domain_name', 'Pages::page/do_i_need_a_domain_name');
	$subroutes->get('what_is_a_domain_registrar', 'Pages::page/what_is_a_domain_registrar');
	$subroutes->get('can_i_host_my_website_on_shared_hosting', 'Pages::page/can_i_host_my_website_on_shared_hosting');
	$subroutes->get('should_i_use_a_domain_name_generator', 'Pages::page/should_i_use_a_domain_name_generator');
	$subroutes->get('home', 'Pages::page/home');
	$subroutes->get('home', 'Pages::page/home');
	$subroutes->get('home', 'Pages::page/home');
	$subroutes->get('anjuu', 'Pages::page/anjuu');
	$subroutes->get('_can_i_host_wordpress_on_shared_hosting', 'Pages::page/_can_i_host_wordpress_on_shared_hosting');
	$subroutes->get('web_hosting', 'Pages::page/web_hosting');
	$subroutes->get('is_.com_domain_still_the_best', 'Pages::page/is_.com_domain_still_the_best');
	$subroutes->get('do_i_need_a_domain_name', 'Pages::page/do_i_need_a_domain_name');
	...
	$subroutes->get('home', 'Pages::page/home');
	$subroutes->get('home', 'Pages::page/home');
	$subroutes->get('dgfhdgfgqewdfdf', 'Pages::page/dgfhdgfgqewdfdf');
	$subroutes->get('wretyfgyjklq24retr', 'Pages::page/wretyfgyjklq24retr');
	$subroutes->get('_can_i_host_wordpress_on_shared_hosting', 'Pages::page/_can_i_host_wordpress_on_shared_hosting');
	$subroutes->get('web_hosting', 'Pages::page/web_hosting');
	$subroutes->get('is_.com_domain_still_the_best', 'Pages::page/is_.com_domain_still_the_best');
	$subroutes->get('do_i_need_a_domain_name', 'Pages::page/do_i_need_a_domain_name');
