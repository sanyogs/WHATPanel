...
class Connection extends BaseConnection
{
    ...
    protected function _fieldData(string $table): array
    {
        ...
        if (($query = $this->query($sql)) === false) {
            throw new DatabaseException(lang('hd_lang.Database.failGetFieldData'));
        }
    ...
    protected function _indexData(string $table): array
    {
        ...
        if (($query = $this->query($sql)) === false) {
            throw new DatabaseException(lang('hd_lang.Database.failGetIndexData'));
        }
        $query = $query->getResultObject();
    ...
    protected function _foreignKeyData(string $table): array
    {
        ...
        if ($query === false) {
            throw new DatabaseException(lang('hd_lang.Database.failGetForeignKeyData'));
        }
    ...
    {
        if ($procedureName === '') {
            throw new DatabaseException(lang('hd_lang.Database.invalidArgument', [$procedureName]));
        }
