...
class DataException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang('hd_lang.Database.invalidEvent', [$method]));
    }
    ...
    {
        return new static(lang('hd_lang.Database.emptyDataset', [$mode]));
    }
    ...
    {
        return new static(lang('hd_lang.Database.emptyPrimaryKey', [$mode]));
    }
    ...
    {
        return new static(lang('hd_lang.Database.invalidArgument', [$argument]));
    }

    public static function forInvalidAllowedFields(string $model)
    {
        return new static(lang('hd_lang.Database.invalidAllowedFields', [$model]));
    }

    public static function forTableNotFound(string $table)
    {
        return new static(lang('hd_lang.Database.tableNotFound', [$table]));
    }

    public static function forEmptyInputGiven(string $argument)
    {
        return new static(lang('hd_lang.Database.forEmptyInputGiven', [$argument]));
    }

    public static function forFindColumnHaveMultipleColumns()
    {
        return new static(lang('hd_lang.Database.forFindColumnHaveMultipleColumns'));
    }
}
