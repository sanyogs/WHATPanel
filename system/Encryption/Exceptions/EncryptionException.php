...
class EncryptionException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang('hd_lang.Encryption.noDriverRequested'));
    }
    ...
    {
        return new static(lang('hd_lang.Encryption.noHandlerAvailable', [$handler]));
    }
    ...
    {
        return new static(lang('hd_lang.Encryption.unKnownHandler', [$driver]));
    }
    ...
    {
        return new static(lang('hd_lang.Encryption.starterKeyNeeded'));
    }
    ...
    {
        return new static(lang('hd_lang.Encryption.authenticationFailed'));
    }
    ...
    {
        return new static(lang('hd_lang.Encryption.encryptionFailed'));
    }
}
