...
class PublisherException extends FrameworkException
{
    ...
    {
        return new static(lang('hd_lang.Publisher.collision', [filetype($to), $from, $to]));
    }
    ...
    {
        return new static(lang('hd_lang.Publisher.destinationNotAllowed', [$destination]));
    }
    ...
    {
        return new static(lang('hd_lang.Publisher.fileNotAllowed', [$file, $directory, $pattern]));
    }
}
