...
class ValidationException extends FrameworkException
{
    ...
    {
        return new static(lang('hd_lang.Validation.ruleNotFound', [$rule]));
    }
    ...
    {
        return new static(lang('hd_lang.Validation.groupNotFound', [$group]));
    }
    ...
    {
        return new static(lang('hd_lang.Validation.groupNotArray', [$group]));
    }
    ...
    {
        return new static(lang('hd_lang.Validation.invalidTemplate', [$template]));
    }
    ...
    {
        return new static(lang('hd_lang.Validation.noRuleSets'));
    }
}
