...
class CookieException extends FrameworkException
{
    ...
    {
        return new static(lang('hd_lang.Cookie.invalidExpiresTime', [$type]));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.invalidExpiresValue'));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.invalidCookieName', [$name]));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.emptyCookieName'));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.invalidSecurePrefix'));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.invalidHostPrefix'));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.invalidSameSite', [$sameSite]));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.invalidSameSiteNone'));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.invalidCookieInstance', $data));
    }
    ...
    {
        return new static(lang('hd_lang.Cookie.unknownCookieInstance', $data));
    }
}
