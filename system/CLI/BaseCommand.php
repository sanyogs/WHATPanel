...
abstract class BaseCommand
{
    ...
    {
        CLI::write(lang('hd_lang.CLI.helpUsage'), 'yellow');
        ...
        if (! empty($this->description)) {
            CLI::newLine();
            CLI::write(lang('hd_lang.CLI.helpDescription'), 'yellow');
            CLI::write($this->setPad($this->description, 0, 0, 2));
        }

        if (! empty($this->arguments)) {
            CLI::newLine();
            CLI::write(lang('hd_lang.CLI.helpArguments'), 'yellow');
        ...
        if (! empty($this->options)) {
            CLI::newLine();
            CLI::write(lang('hd_lang.CLI.helpOptions'), 'yellow');
