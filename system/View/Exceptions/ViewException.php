...
class ViewException extends FrameworkException
{
    ...
    {
        return new static(lang('hd_lang.View.invalidCellMethod', ['class' => $class, 'method' => $method]));
    }
    ...
    {
        return new static(lang('hd_lang.View.missingCellParameters', ['class' => $class, 'method' => $method]));
    }
    ...
    {
        return new static(lang('hd_lang.View.invalidCellParameter', [$key]));
    }
    ...
    {
        return new static(lang('hd_lang.View.noCellClass'));
    }
    ...
    {
        return new static(lang('hd_lang.View.invalidCellClass', [$class]));
    }
    ...
    {
        return new static(lang('hd_lang.View.tagSyntaxError', [$output]));
    }
    ...
    {
        return new static(lang('hd_lang.View.invalidDecoratorClass', [$className]));
    }
}
