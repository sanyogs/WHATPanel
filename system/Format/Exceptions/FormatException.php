...
class FormatException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang('hd_lang.Format.invalidFormatter', [$class]));
    }
    ...
    {
        return new static(lang('hd_lang.Format.invalidJSON', [$error]));
    }
    ...
    {
        return new static(lang('hd_lang.Format.invalidMime', [$mime]));
    }
    ...
    {
        return new static(lang('hd_lang.Format.missingExtension'));
    }
}
