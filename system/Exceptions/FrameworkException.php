...
class FrameworkException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang('hd_lang.Core.enabledZlibOutputCompression'));
    }
    ...
    {
        return new static(lang('hd_lang.Core.invalidFile', [$path]));
    }
    ...
    {
        return new static(lang('hd_lang.Core.invalidDirectory', [$path]));
    }
    ...
    {
        return new static(lang('hd_lang.Core.copyError', [$path]));
    }
    ...
    public static function forMissingExtension(string $extension)
    {
        if (strpos($extension, 'intl') !== false) {
            ...
            $message = lang('hd_lang.Core.missingExtension', [$extension]);
        }
    ...
    {
        return new static(lang('hd_lang.Core.noHandlers', [$class]));
    }
    ...
    {
        return new static(lang('hd_lang.Fabricator.createFailed', [$table, $reason]));
    }
}
