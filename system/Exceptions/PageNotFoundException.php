...
class PageNotFoundException extends OutOfBoundsException implements ExceptionInterface, HTTPExceptionInterface
{
    ...
    {
        return new static($message ?? self::lang('hd_lang.HTTP.pageNotFound'));
    }
    ...
    {
        return new static(self::lang('hd_lang.HTTP.emptyController'));
    }
    ...
    {
        return new static(self::lang('hd_lang.HTTP.controllerNotFound', [$controller, $method]));
    }
    ...
    {
        return new static(self::lang('hd_lang.HTTP.methodNotFound', [$method]));
    }
    ...
    {
        return new static(self::lang('hd_lang.HTTP.localeNotSupported', [$locale]));
    }
