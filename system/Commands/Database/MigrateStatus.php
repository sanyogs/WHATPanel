...
class MigrateStatus extends BaseCommand
{
    ...
    public function run(array $params)
    {
        ...
        if (! $status) {
            // @codeCoverageIgnoreStart
            CLI::error(lang('hd_lang.Migrations.noneFound'), 'light_gray', 'red');
            CLI::newLine();
        ...
        $headers = [
            CLI::color(lang('hd_lang.Migrations.namespace'), 'yellow'),
            CLI::color(lang('hd_lang.Migrations.version'), 'yellow'),
            CLI::color(lang('hd_lang.Migrations.filename'), 'yellow'),
            CLI::color(lang('hd_lang.Migrations.group'), 'yellow'),
            CLI::color(str_replace(': ', '', lang('hd_lang.Migrations.on')), 'yellow'),
            CLI::color(lang('hd_lang.Migrations.batch'), 'yellow'),
        ];
