...
return [
    'sourceImageRequired'    => 'يجب تحديد مصدر الصورة في الاعدادات.',
    ...
    'webpNotSupported'       => 'الصورة من نوع WEBP غير مدعومة.',
    'fileNotSupported'       => 'إن الملف المحدد ليس صورة ذات نوع مدعوم.',
    'unsupportedImageCreate' => 'مكتبة الصور GD  لا تدعم معالجة هذا النوع من الصور.',
    'jpgOrPngRequired'       => 'نظام تغيير حجم الصور المحدد يدعم فقط الصور من نوع JPEG أو PNG.',
    'rotateUnsupported'      => 'تدوير الصور غير مدعوم في الخادم الخاص بك.',
    'libPathInvalid'         => 'مسار مكتبة الصور غير صحيح. الرجاء وضع المسار الصحيح في الاعدادات. {0}',
    'imageProcessFailed'     => 'فشل في معالجة الصورة. الرجاء التأكد من ان نظام الصور مدعوم ومسار مكتبة الصور صحيح.',
    'rotationAngleRequired'  => 'يجب تحديد زاوية التدوير لكي يتم تدوير الصورة.',
    'invalidPath'            => 'مسار الصورة غير صحيح.',
