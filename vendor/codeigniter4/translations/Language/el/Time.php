...
return [
    'invalidFormat'  => '"{0}" δεν είναι έγκυρη μορφή ημερομηνίας (datetime)', // '"{0}" is not a valid datetime format',
    'invalidMonth'   => 'Οι μήνες πρέπει να είναι μεταξύ 1 και 12. Δόθηκε: {0}', // 'Months must be between 1 and 12. Given: {0}',
    'invalidDay'     => 'Οι ημέρες πρέπει να είναι μεταξύ 1 και 31. Δόθηκε: {0}', // 'Days must be between 1 and 31. Given: {0}',
    'invalidOverDay' => 'Οι ημέρες πρέπει να είναι μεταξύ 1 και {0}. Δόθηκε: {1}', // 'Days must be between 1 and {0}. Given: {1}',
