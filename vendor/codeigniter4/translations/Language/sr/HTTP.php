...
return [
    ...
    // IncomingRequest
    'invalidNegotiationType' => '{0} nije validan negotacioni tip. Mora biti jedan od: media, charset, encoding, language.',

    // Message
    'invalidHTTPProtocol' => 'Nevalidna verzija HTTP Protokola. Mora biti jedna od: {0}',

    // Negotiate
    'emptySupportedNegotiations' => 'Morate proslediti niz podržanih vrednosti na sve negotacije.',
    ...
    'cannotSetStatusCode'    => 'Nije podržana promena status koda za preuzimanje. kod: {0}, razlog: {1}',

    // Response
    'missingResponseStatus' => 'U HTTP odgovoru nedostaje status kod',
    'invalidStatusCode'     => '{0} nije validan status kod HTTP odgovora',
    'unknownStatusCode'     => 'Dotstavljen nepoznat HTTP status kod bez poruke: {0}',

    // URI
    'cannotParseURI'       => 'Nije moguće obraditi URI: {0}',
    'segmentOutOfRange'    => 'Zahtevani URI segment je izvan opsega: {0}',
    'invalidPort'          => 'Portovi moraju biti između 0 i 65535. Dat port: {0}',
    'malformedQueryString' => 'Delovi zahteva možda ne uključuju URI fragmente.',
    ...
    'disallowedAction' => 'Zahtevana akcija nije dozvoljena.',

    // Uploaded file moving
    'alreadyMoved' => 'Uploadovana datoteka je pomerena.',
    'invalidFile'  => 'Orginalna datoteka nije validna.',
    'moveFailed'   => 'ne mogu pomeriti datoteku {0} na {1} ({2})',

    'uploadErrOk'        => 'Datoteka je uspešno uploadovana.',
    ...
    'uploadErrPartial'   => 'Datoteka "%s" je samo delimično uploadovana.',
    'uploadErrNoFile'    => 'Datoteka nije uploadovana.',
    'uploadErrCantWrite' => 'Datoteka "%s" ne može biti zapisana na disk.',
    'uploadErrNoTmpDir'  => 'Datoteka ne može biti uploadovana: nedostaje privremeni direktorijum.',
