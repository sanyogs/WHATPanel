...
return [
    'collision'             => 'A Publisher váratlan {0} elemet észlelt, miközben a(z) {1} fájlt a(z) {2} helyre másolta.',
    'destinationNotAllowed' => 'A cél nem szerepel a Publisher könyvtárak engedélyezett listáján: {0}',
