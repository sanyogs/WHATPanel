...
return [
    'sourceImageRequired'    => 'Meg kell adni a kép forrását a beállításoknál.',
    'gdRequired'             => 'Ehhez a funkcióhoz a GD képkönyvtárra van szükség.',
    'gdRequiredForProps'     => 'A szervernek támogatnia kell a GD képkönyvtárat a kép tulajdonságainak megállapításához.',
    'gifNotSupported'        => 'A GIF képek gyakran nem támogatottak licensz megkötések miatt. Helyette JPG vagy PNG kép használata javasolt.',
    'jpgNotSupported'        => 'A JPG képek nem támogatottak.',
    ...
    'copyFailed'             => 'A képmásoló eljárás közben hiba történt.',
    'missingFont'            => 'A használni kívánt betűtípus nem található.',
