...
return [
    ...
    'migHelpRefresh'  => "\t\tAvinstallerar alla migreringar och kör om dessa för att uppdatera databasen.",
    'migHelpSeed'     => "\tKör seeder:n med namnet [name].",
    'migCreate'       => "\tSkapar en ny seeder med namnet [name]",
    'nameMigration'   => 'Namnge migreringsfilen',
    'migNumberError'  => 'Migreringens nummer måste vara tre siffror och det får inte vara luckor i sekvensen.',
